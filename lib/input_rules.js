const tag_rules= {'regex':/#[a-zA-Z0-9]{1,50}\b/g,'min':1,'max':50,'error':'Invalid tags'}
...
module.exports = {tag_rules,edit_code_rules,custom_url_rules,text_header_rules,text_body_rules}
